...
- [ ] Day 2 — Sorting, DISTINCT, LIMIT, string/date functions
- [ ] Day 3 — Aggregation: GROUP BY, HAVING
- ...
 
## Structure
Each `dayXX.sql` file contains that day's practice queries, commented with the business question each one answers.
